...
class BuscarHistoriaPs extends StatefulWidget {
  const BuscarHistoriaPs({super.key});

  @override
  _BuscarHistoriaPsState createState() => _BuscarHistoriaPsState();
}
...
class _BuscarHistoriaPsState extends State<BuscarHistoriaPs> {
  ...
  void _activarEdicion() {
    setState(() {
      ...
      if (!_modoEdicion) {
        _llenarCamposControllers(); // Si cancelamos la edición, recargamos los valores originales
      }
    });
  }
